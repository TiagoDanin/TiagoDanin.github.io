...
date: "2025-08"
description: "Automatizando documentação e testes de apps Android com um agente de IA no Claude Code, ligado a um servidor MCP que controla um aparelho real via ADB."
