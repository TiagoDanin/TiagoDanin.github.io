...
slug: "creating-an-ai-agent-in-claude-code-to-control-my-smartphone"
...
lang: "pt"
cover: "/images/posts/criando-um-agente-de-ia-no-claude-code-para-controlar-meu-smartphone/cover.png"
tags: ["Android", "AI", "Mobile", "UI/UX", "Testing", "Tools", "Article"]
---

![Criando um Agente de IA no Claude Code para Controlar meu Smartphone](/images/posts/criando-um-agente-de-ia-no-claude-code-para-controlar-meu-smartphone/cover.png)
...
![Diagrama do agente controlando o smartphone via ADB](/images/posts/criando-um-agente-de-ia-no-claude-code-para-controlar-meu-smartphone/agent-diagram.png)
...
<YouTubeEmbed videoId="zp38frEGcPA" title="Criando um Agente de IA no Claude Code para Controlar meu Smartphone" />
