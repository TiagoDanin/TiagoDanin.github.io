...
date: "2025-08"
description: "Automating Android app documentation and testing with an AI agent in Claude Code, wired to an MCP server that drives a real device over ADB."
