...
export default function RootLayout({
  ...
  // Not migrated to /[lang] yet, so these routes are English by definition.
  // Still has to run: any shared component marked with <Trans> reads the
  // instance this publishes.
