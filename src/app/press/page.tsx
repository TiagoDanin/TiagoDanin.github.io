          ...
          <div className="max-w-2xl space-y-6">
            ...
            <dl className="grid grid-cols-2 sm:grid-cols-3 gap-x-6 gap-y-5 pt-7 border-t border-border/60">
              <div className="space-y-1">
                ...
                <dd className="text-xs text-muted-foreground leading-tight">pieces</dd>
              </div>
              <div className="space-y-1">
                <dt className="text-xl sm:text-2xl font-bold tabular-nums tracking-tight">
                  {outlets.length}
                </dt>
                <dd className="text-xs text-muted-foreground leading-tight">outlets</dd>
              </div>
              <div className="space-y-1">
                <dt className="text-xl sm:text-2xl font-bold tabular-nums tracking-tight">
                  {range}
                </dt>
                <dd className="text-xs text-muted-foreground leading-tight">published</dd>
              </div>
            </dl>
          </div>
        </div>
